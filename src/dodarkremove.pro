; NAME:
;     DODARKREMOVE - Version 1.0
;
; PURPOSE: 

; CALLING SEQUENCE:
;     DODARKREMOVE, INDATA, RECURSIVE=RECURSIVE
;
; INPUTS:
...
PRO DoDarkRemove, indata, recursive=recursive, keyword=keyword, keypath=keypath
  
  object = OBJ_NEW('RUNDARK', $
  ...
  object->Run,prodfolder='biasremove'
